...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_manager__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addressfinder_addressfinder_webpage_tools__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_js_fn_array_for_each__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__address_form_config_user_registration_region_mappings__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__address_form_config_user_registration_state_mappings__ = __webpack_require__(40);
...
function () {
  ...
  _createClass(ConfigManager, [{
    ...
    value: function generateDynamicForms() {
      ...
      var dynamicForms = []; // find all elements with an ID starting with address_form_. For example id="address_form_345987345"

      var identifyingElements = Array.from(document.querySelectorAll('[id^="address_form_"]')); // create a new form configuration for each 'address_form_' form we find
    ...
    value: function _configureDynamicForm(identifyingElement, index) {
      if (identifyingElement) {
        ...
        var formConfig = {
          label: "User Address Form ".concat(index),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__region_mappings__ = __webpack_require__(10);
